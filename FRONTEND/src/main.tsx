...
import { faFolderClosed, faClapperboard, faFile, faFileAudio, faFileCode, faFileZipper, faFileWord } from '@fortawesome/free-solid-svg-icons'
...
library.add(
  ...
  faFolderClosed, faClapperboard, faFile, faFileAudio, faFileCode, faFileZipper, faFileWord // FsEntity's icons
)